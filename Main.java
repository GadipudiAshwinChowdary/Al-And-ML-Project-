...
public Main(){
	...
	l1 = new JLabel("<HTML><BODY><CENTER>Towards Secure Industrial IoT: Blockchain System with Credit-Based<br/> Consensus Mechanism</CENTER></BODY></HTML>".toUpperCase());
	l1.setForeground(Color.white);
	l1.setFont(new Font("Courier New",Font.PLAIN,17));
	p2.add(l1);

	l2 = new JLabel("Wireless IIOT Sensors Configuration Screen");
	l2.setFont(new Font("Courier New",Font.BOLD,13));
	l2.setBounds(180,20,400,30);
	p1.add(l2);

	l3 = new JLabel("Wireless Sensors Size");
	...
	l4 = new JLabel("Industrial Port No");
